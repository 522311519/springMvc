...
import com.test.manager.service.impl.ArticleServiceImpl;
...
public class ArticleController extends BaseController {
    ...
    public BaseModel getArticle(String articleId) {
        List<ArticleModel> models = articleServiceImpl.getArticle(articleId);
    ...
    public BaseModel addArticle(HttpSession session, ArticleModel model) {
        ...
        if (model == null) {
            ...
            int code = articleServiceImpl.add(model);
            if (code == 0) {
    ...
    public BaseModel updateArticle(HttpSession session, ArticleModel model) {
        ...
        if (model == null) {
            ...
            int code = articleServiceImpl.update(model);
            if (code == 0) {
    ...
    public BaseModel deleteArticle(HttpSession session, String articleId) {
        ...
        if (TextUtils.isEmpty(articleId)) {
            ...
            int code = articleServiceImpl.delete(articleId);
            if (code == 0) {
